    ...
    <div className={`${styles.container} container-fluid d-flex align-items-center justify-content-center`}>
      <div className={styles.registrationFormContainer}>
        ...
        <fieldset className='border p-3 rounded'>
          <legend className={`${styles.registrationFormLegend} border rounded p-1 text-center`}>Registration Form</legend>
          <form onSubmit={handleSubmit(onSubmit)} noValidate autoComplete='off'>
            <div className='form-group'>
              ...
              />
              {errors.email && <span className={`${styles.errorMessage} mandatory`}>{errors.email.message}</span>}
            </div>
            <div className='form-group'>
              ...
              />
              {errors.name && <span className={`${styles.errorMessage} mandatory`}>{errors.name.message}</span>}
            </div>
            <div className='form-group'>
              ...
              />
              {errors.password && <span className={`${styles.errorMessage} mandatory`}>{errors.password.message}</span>}
            </div>
